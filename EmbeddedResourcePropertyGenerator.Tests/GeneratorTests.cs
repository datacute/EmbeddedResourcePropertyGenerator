...
{
    const string InputSource = /* language=c# */
        $$"""
          using Datacute.EmbeddedResourcePropertyGenerator;
    ...
    [InlineData(-1)]
    [InlineData(1)]
    public void CanGenerate(int indexToModify)
    {
        ...
        var (diagnostics, output)
            = TestHelper.GetGeneratedOutput<EmbeddedResourcePropertiesAttribute, Generator, TrackingNames>(
                _additionalTexts, 
                indexToModify, 
                [],
                InputSource);
    ...
    {
        const string expectedBeforeChange = /* language=c# */
            $$"""
              //------------------------------------------------------------------------------
              // <auto-generated>
              //     This code was generated by the Datacute.EmbeddedResourcePropertyGenerator.
        ...
        var (diagnostics, output)
            = TestHelper.GetGeneratedOutput<EmbeddedResourcePropertiesAttribute, Generator, TrackingNames>(
                ...
                0, 
                [
                    nameof(TrackingNames.EmbeddedResourceDocComments), 
                    nameof(TrackingNames.Combine), nameof(TrackingNames.SourceOutput)],
                InputSource);

        // Assert the output
        using var s = new AssertionScope();
        diagnostics.Should().BeEmpty();
        output.LastOrDefault().Should().Be(expectedBeforeChange);
    }
}