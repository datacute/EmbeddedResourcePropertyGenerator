...
namespace Datacute.EmbeddedResourcePropertyGenerator
{
    public readonly struct CodeGenerator
    {
        ...
        private void ReadingMethods()
        {
            if (_options.IsDesignTimeBuild) return;

            _buffer.AppendFormat(Templates.ReadingMethods, _context.Name);
        }
        ...
        private void BackingFields()
        {
            ...
            _buffer.AppendLine(Templates.BackingFields);
        ...
        private void ResourceNames()
        {
            ...
            _buffer.AppendLine(Templates.ResourceNames);
        ...
        private void AppendHelperMethods() => _buffer.AppendLine(Templates.ReadEmbeddedResourceValueMethod);
        ...
        private void AppendEndClass() => _buffer.AppendLine("}");
    }
}